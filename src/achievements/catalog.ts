...
import { hubIconUrl } from '@/assets/icons/hub'
import { modeArtUrl } from '@/assets/modes'
import { tableArtUrl } from '@/assets/tables'
import { mundoLenguas } from '@/assets/worlds'
...
const generalAchievements: AchievementDefinition[] = [
  ...
  },
  {
    ...
    category: 'insignias',
    image: modeArtUrl('calc-truefalse'),
    reward: { energy: 30 },
    current: (progress) => statsOf(progress).bestGoodSessionStreak,
    target: 5,
  },
...
const matesAchievements: AchievementDefinition[] = [
  {
    ...
    category: 'mates',
    image: zoneMarkArtUrl('calc') ?? dailySkillIcons.calc,
    reward: { energy: 10 },
