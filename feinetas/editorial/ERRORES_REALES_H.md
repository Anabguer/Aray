...
Este documento recoge errores ortográficos reales relacionados con la H para alumnos de 3.º de Primaria en Cataluña.

Este documento es la fuente oficial para crear posteriormente los bancos JSON.

Nunca debe contener palabras inventadas.

**Metodología:** registros contrastados con fichas/materiales del repositorio (`editorial/README.md`). No se copian ejercicios; se reutilizan vocabulario y reglas de 3.º.

**Cruce:** el trío *hay / ahí / ay* tiene documento propio (`ERRORES_REALES_HAY_AHI_AY.md`). Aquí no se duplica ese banco.
...
Las palabras que empiezan por hie- se escriben con h.
...
ANAYA ampliación 3.º: ejercicio de palabras con h y pregunta explícita (hierba, hueco, hielo, hueso).
...
ANAYA ampliación 3.º («se rompió un ___ de la mano»).
...
Las formas del verbo hacer se escriben con h. No confundir con echar (sin h).
...
Vicens Vives 3.º: completar formas de haber / hablar / hacer.
...
ANAYA ampliación (texto: «allí hice muchos amigos»).
...
ANAYA ampliación (texto: «la primera vez que hacía este viaje»).
...
Hecho (hacer) lleva h. Echo (echar) no lleva h. Son verbos distintos.
...
Echar se escribe sin h. El error frecuente es añadir una h (hechar).
...
Regla hacer/echar separada: aquí la correcta es echar (sin h).
...
Echa (echar) va sin h. Hecha es de hacer / participio con h.
...
Echo (echar, 1.ª persona) va sin h. Hecho es de hacer.
...
Las formas del verbo haber se escriben con h. (El uso de «hay» se detalla en su banco propio.)
...
Ha (haber) lleva h. La preposición a no lleva h.
...
ANAYA ampliación («Hoy he ido al hospital…»).
...
Formas de haber se escriben con h.
...
Muy presente en textos ANAYA / fábulas del material 3.º.
...
Aparece en textos de refuerzo/ampliación 3.º.
...
Hasta (preposición) lleva h. Asta (cuerno) es otra palabra.
...
Hola (saludo) lleva h. Ola (mar) es otra palabra.
...
Pareja de hijo en vocabulario familiar de 3.º.
...
Las palabras con herm- se escriben con h.
...
Vicens / ANAYA / Savia (hermano, hermanos en textos).
...
Hombre lleva h aunque no se oye.
...
Hogar lleva h aunque no se oye.
...
Hambre lleva h aunque no se oye.
...
ANAYA refuerzo («No tengo hambre»).
...
ANAYA refuerzo («¿Cuántos higos te comiste?»).
...
Helado lleva h aunque no se oye.
...
Vicens Vives 3.º (texto con helados).
...
ANAYA ampliación (hormigas / hormiguero); fábula en material 3.º.
...
Hombro lleva h aunque no se oye.
...
ANAYA ampliación (definición: mano al hombro).
...
Hospital lleva h aunque no se oye.
...
Historia lleva h aunque no se oye.
