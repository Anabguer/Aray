# Frases — Completar (Ortografía 3.º)
...
Temario 3.º; ANAYA/Vicens (uso de hay); ERRORES_REALES_HAY_AHI_AY.md
...
He dejado el libro ___ encima de la mesa.
...
Temario 3.º; tomo2 (uso de ahí); ERRORES_REALES_HAY_AHI_AY.md
...
Vicens (uso de ¡ay!); ERRORES_REALES_HAY_AHI_AY.md
...
Signos de exclamación en la frase, no en la opción.
...
¿___ algún asiento libre a la sombra?
...
Hay pregunta por la existencia de algo.

## Fuente

Temario; ERRORES_REALES_HAY_AHI_AY.md
...
Siéntate ___ , junto a la ventana.
...
Luisa ha ___ una pajarita de papel.
...
ERRORES_REALES_H.md (hecho/echo); Vicens
...
Yo ___ la basura en el contenedor cada tarde.
...
ERRORES_REALES_H.md (echo/hecho)
...
Mi hermano ___ los deberes después del cole.
...
Hacer se escribe con h; no confundir con echar.

## Fuente

Vicens; ERRORES_REALES_H.md
...
Ramona ___ el ramo de flores al agua.
...
Echa es de echar (sin h).

## Fuente

ERRORES_REALES_H.md (echa/hecha; hechar)
...
Había es una forma del verbo haber.

## Fuente

Vicens; ERRORES_REALES_H.md (había)
...
Ya ___ terminado el dibujo del mapa.
...
Hemos es una forma del verbo haber.
...
La gallina puso un ___ en el nido.
...
Las palabras con hue- llevan h.

## Fuente

ANAYA ampliación; ERRORES_REALES_H.md (huevo)
...
En invierno el lago se llena de ___.
...
Las palabras con hie- llevan h.

## Fuente

ANAYA ampliación; ERRORES_REALES_H.md (hielo)
...
Hierro lleva h al inicio.

## Fuente

ANAYA; ERRORES_REALES_H.md (hierro)
...
El ___ llegó corriendo hasta el carro.
...
ANAYA; ERRORES_REALES_RR.md (perro/pero)
...
Los gorriones volaban ___ de la torre.
...
Tras l va una sola r.

## Fuente

ERRORES_REALES_RR.md (alrededor)
...
ERRORES_REALES_MPMB.md (también)
...
Se me ha roto el ___ izquierdo.
...
El sonido /θa/ al inicio se escribe za-.

## Fuente

ERRORES_REALES_CZQU.md (zapato)
...
Antes de i el sonido /θ/ se escribe c.

## Fuente

ERRORES_REALES_CZQU.md (ciudad)
...
Lluvia se escribe con ll.

## Fuente

ERRORES_REALES_LLY.md (lluvia)
...
Ventana se escribe con v.

## Fuente

ERRORES_REALES_BV.md (ventana)
...
Había mucha ___ en la fiesta del pueblo.
...
Gente se escribe con g.

## Fuente

ERRORES_REALES_GJ.md (gente)
...
En el zoo vimos una ___ altísima.
...
En clase de música tocamos la ___.
...
Guitarra se escribe con gu.

## Fuente

ERRORES_REALES_GU.md (guitarra); ANAYA gu/diéresis
...
En el nido del campanario vimos una ___.
...
La u se oye: se escribe gü.

## Fuente

ERRORES_REALES_GU.md (cigüeña)
